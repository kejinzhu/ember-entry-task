...
define("entry-task/tests/acceptance/list-rentals-test", ["qunit", "@ember/test-helpers", "ember-qunit"], function (_qunit, _testHelpers, _emberQunit) {
  "use strict";
...
define("entry-task/tests/integration/components/channel-button-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | channel-button', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "oqJEoYpZ",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"channel-button\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "kRaQsXGi",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"channel-button\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define("entry-task/tests/integration/components/channel-choice-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | channel-choice', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "BUyh4Kpq",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"channel-choice\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "VZLDE02H",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"channel-choice\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/comment-list-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | comment-list', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "FlCl0dri",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"comment-list\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "TMcRBWq9",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"comment-list\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/comment-user-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | comment-user', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "atWY5+UV",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"comment-user\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "Wg4d+01x",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"comment-user\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/e-button-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | e-button', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "qQvpb/55",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"e-button\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "kJZqde5j",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"e-button\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/e-header-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | e-header', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "BQPZG9d7",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"e-header\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "fq/fT+88",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"e-header\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/e-home-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | e-home', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "cRKn0Y2p",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"e-home\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "euEBXh3N",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"e-home\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/e-me-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | e-me', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "i8PXWawF",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"e-me\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "nM1RpBqy",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"e-me\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/e-search-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | e-search', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "HUXKXfgk",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"e-search\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "S1va5oDY",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"e-search\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/event-list-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | event-list', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "2G3gO5ga",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"event-list\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "ACFsKY84",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"event-list\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/nav-link-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | nav-link', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "ufpPHRkV",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"nav-link\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "C68IAZSS",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"nav-link\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/no-result-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | no-result', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "IUGPqRDn",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"no-result\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "ekvkhg89",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"no-result\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/reply-comment-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | reply-comment', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "VvXoUCJ+",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"reply-comment\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "3SDbD+zR",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"reply-comment\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/slide-bar-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | slide-bar', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "BgVIubjX",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"slide-bar\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "4fhw53f6",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"slide-bar\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/user-nav-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | user-nav', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "JyPZO6NX",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"user-nav\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "HPMzOK56",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"user-nav\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/integration/components/view-all-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | view-all', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "CQV2UBKK",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"view-all\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), ''); // Template block usage:
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "iYPpGkhA",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"view-all\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
      assert.equal(this.element.textContent.trim(), 'template block text');
    });
...
define("entry-task/tests/lint/app.lint-test", [], function () {
  "use strict";

  QUnit.module('ESLint | app');
  QUnit.test('adapters/application.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'adapters/application.js should pass ESLint\n\n12:59 - Unnecessary escape character: \\=. (no-useless-escape)');
  });
  QUnit.test('app.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'app.js should pass ESLint\n\n');
  });
  QUnit.test('components/channel-button.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/channel-button.js should pass ESLint\n\n4:9 - \'event\' is defined but never used. (no-unused-vars)');
  });
  QUnit.test('components/channel-choice.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/channel-choice.js should pass ESLint\n\n43:7 - Unexpected console statement. (no-console)');
  });
  QUnit.test('components/comment-list.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/comment-list.js should pass ESLint\n\n');
  });
  QUnit.test('components/comment-user.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/comment-user.js should pass ESLint\n\n');
  });
  QUnit.test('components/e-button.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/e-button.js should pass ESLint\n\n');
  });
  QUnit.test('components/e-header.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/e-header.js should pass ESLint\n\n');
  });
  QUnit.test('components/e-home.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/e-home.js should pass ESLint\n\n');
  });
  QUnit.test('components/e-me.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/e-me.js should pass ESLint\n\n');
  });
  QUnit.test('components/e-search.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/e-search.js should pass ESLint\n\n');
  });
  QUnit.test('components/event-list.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/event-list.js should pass ESLint\n\n');
  });
  QUnit.test('components/nav-link.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/nav-link.js should pass ESLint\n\n');
  });
  QUnit.test('components/no-result.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/no-result.js should pass ESLint\n\n');
  });
  QUnit.test('components/reply-comment.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/reply-comment.js should pass ESLint\n\n');
  });
  QUnit.test('components/slide-bar.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/slide-bar.js should pass ESLint\n\n');
  });
  QUnit.test('components/user-nav.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/user-nav.js should pass ESLint\n\n');
  });
  QUnit.test('components/view-all.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/view-all.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('controllers/details/comments.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/details/comments.js should pass ESLint\n\n');
  });
  QUnit.test('controllers/details/index.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/details/index.js should pass ESLint\n\n');
  });
  QUnit.test('controllers/details/participants.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/details/participants.js should pass ESLint\n\n');
  });
  QUnit.test('controllers/event.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/event.js should pass ESLint\n\n64:9 - Unexpected console statement. (no-console)');
  });
  QUnit.test('controllers/index.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/index.js should pass ESLint\n\n');
  });
  QUnit.test('controllers/me.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/me.js should pass ESLint\n\n');
  });
  QUnit.test('controllers/me/going.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/me/going.js should pass ESLint\n\n');
  });
  QUnit.test('controllers/me/likes.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/me/likes.js should pass ESLint\n\n');
  });
  QUnit.test('controllers/me/past.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/me/past.js should pass ESLint\n\n');
  });
  QUnit.test('helpers/details.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/details.js should pass ESLint\n\n');
  });
  QUnit.test('helpers/event.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/event.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/details.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/details.js should pass ESLint\n\n13:88 - Unnecessary escape character: \\=. (no-useless-escape)\n23:88 - Unnecessary escape character: \\=. (no-useless-escape)\n36:88 - Unnecessary escape character: \\=. (no-useless-escape)');
  });
  QUnit.test('routes/details/comments.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/details/comments.js should pass ESLint\n\n');
  });
  QUnit.test('routes/details/index.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/details/index.js should pass ESLint\n\n');
  });
  QUnit.test('routes/details/participants.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/details/participants.js should pass ESLint\n\n');
  });
  QUnit.test('routes/event.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/event.js should pass ESLint\n\n18:86 - Unnecessary escape character: \\=. (no-useless-escape)');
  });
  QUnit.test('routes/index.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/index.js should pass ESLint\n\n');
  });
  QUnit.test('routes/me.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/me.js should pass ESLint\n\n12:88 - Unnecessary escape character: \\=. (no-useless-escape)\n25:88 - Unnecessary escape character: \\=. (no-useless-escape)');
  });
  QUnit.test('routes/me/going.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/me/going.js should pass ESLint\n\n12:88 - Unnecessary escape character: \\=. (no-useless-escape)');
  });
  QUnit.test('routes/me/likes.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/me/likes.js should pass ESLint\n\n12:88 - Unnecessary escape character: \\=. (no-useless-escape)');
  });
  QUnit.test('routes/me/past.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/me/past.js should pass ESLint\n\n12:88 - Unnecessary escape character: \\=. (no-useless-escape)');
  });
...
define("entry-task/tests/lint/templates.template.lint-test", [], function () {
  "use strict";

  QUnit.module('TemplateLint');
  QUnit.test('entry-task/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/application.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/channel-button.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'entry-task/templates/components/channel-button.hbs should pass TemplateLint.\n\nentry-task/templates/components/channel-button.hbs\n  4:21  error  you must use double quotes in templates  quotes\n');
  });
  QUnit.test('entry-task/templates/components/channel-choice.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'entry-task/templates/components/channel-choice.hbs should pass TemplateLint.\n\nentry-task/templates/components/channel-choice.hbs\n  16:28  error  Incorrect indentation of attribute \'value\' beginning at L16:C28. Expected \'value\' to be at L17:C14.  attribute-indentation\n  16:43  error  Incorrect indentation of attribute \'format\' beginning at L16:C43. Expected \'format\' to be at L18:C14.  attribute-indentation\n  16:63  error  Incorrect indentation of attribute \'onSelection\' beginning at L16:C63. Expected \'onSelection\' to be at L19:C14.  attribute-indentation\n  16:114  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{pikaday-input}}\' beginning at L16:C114. Expected \'{{pikaday-input}}\' to be at L20:C12.  attribute-indentation\n  21:28  error  Incorrect indentation of attribute \'value\' beginning at L21:C28. Expected \'value\' to be at L22:C14.  attribute-indentation\n  21:41  error  Incorrect indentation of attribute \'format\' beginning at L21:C41. Expected \'format\' to be at L23:C14.  attribute-indentation\n  21:61  error  Incorrect indentation of attribute \'onSelection\' beginning at L21:C61. Expected \'onSelection\' to be at L24:C14.  attribute-indentation\n  21:112  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{pikaday-input}}\' beginning at L21:C112. Expected \'{{pikaday-input}}\' to be at L25:C12.  attribute-indentation\n  10:10  error  Incorrect indentation for `<span>` beginning at L10:C10. Expected `<span>` to be at an indentation of 12 but was found at 10.  block-indentation\n  16:83  error  you must use double quotes in templates  quotes\n  21:81  error  you must use double quotes in templates  quotes\n');
  });
  QUnit.test('entry-task/templates/components/comment-list.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/comment-list.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/comment-user.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/comment-user.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/e-button.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/e-button.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/e-header.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/e-header.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/e-home.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/e-home.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/e-me.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/e-me.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/e-search.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/e-search.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/event-list.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'entry-task/templates/components/event-list.hbs should pass TemplateLint.\n\nentry-task/templates/components/event-list.hbs\n  -:-  error  Cannot read property \'original\' of undefined  undefined\n');
  });
  QUnit.test('entry-task/templates/components/nav-link.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/nav-link.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/no-result.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/no-result.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/reply-comment.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/reply-comment.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/slide-bar.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'entry-task/templates/components/slide-bar.hbs should pass TemplateLint.\n\nentry-task/templates/components/slide-bar.hbs\n  3:2  error  Incorrect indentation for `<li>` beginning at L3:C2. Expected `<li>` to be at an indentation of 4 but was found at 2.  block-indentation\n');
  });
  QUnit.test('entry-task/templates/components/user-nav.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/user-nav.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/components/view-all.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/components/view-all.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/details.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/details.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/details/comments.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/details/comments.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/details/index.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/details/index.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/details/participants.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'entry-task/templates/details/participants.hbs should pass TemplateLint.\n\nentry-task/templates/details/participants.hbs\n  21:0  error  Incorrect indentation for `{{no-result}}` beginning at L21:C0. Expected `{{no-result}}` to be at an indentation of 2 but was found at 0.  block-indentation\n');
  });
  QUnit.test('entry-task/templates/event.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'entry-task/templates/event.hbs should pass TemplateLint.\n\nentry-task/templates/event.hbs\n  15:19  error  Incorrect indentation of attribute \'channel\' beginning at L15:C19. Expected \'channel\' to be at L16:C4.  attribute-indentation\n  15:41  error  Incorrect indentation of attribute \'search\' beginning at L15:C41. Expected \'search\' to be at L17:C4.  attribute-indentation\n  15:61  error  Incorrect indentation of attribute \'fromDate\' beginning at L15:C61. Expected \'fromDate\' to be at L18:C4.  attribute-indentation\n  16:2  error  Incorrect indentation of attribute \'toDate\' beginning at L16:C2. Expected \'toDate\' to be at L19:C4.  attribute-indentation\n  16:22  error  Incorrect indentation of attribute \'onClick\' beginning at L16:C22. Expected \'onClick\' to be at L20:C4.  attribute-indentation\n  16:49  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{channel-choice}}\' beginning at L16:C49. Expected \'{{channel-choice}}\' to be at L21:C2.  attribute-indentation\n');
  });
  QUnit.test('entry-task/templates/index.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'entry-task/templates/index.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('entry-task/templates/me.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'entry-task/templates/me.hbs should pass TemplateLint.\n\nentry-task/templates/me.hbs\n  13:15  error  Incorrect indentation of attribute \'goings_count\' beginning at L13:C15. Expected \'goings_count\' to be at L14:C6.  attribute-indentation\n  13:47  error  Incorrect indentation of attribute \'likes_count\' beginning at L13:C47. Expected \'likes_count\' to be at L15:C6.  attribute-indentation\n  13:77  error  Incorrect indentation of attribute \'past_count\' beginning at L13:C77. Expected \'past_count\' to be at L16:C6.  attribute-indentation\n  13:104  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{user-nav}}\' beginning at L13:C104. Expected \'{{user-nav}}\' to be at L17:C4.  attribute-indentation\n  31:4  error  Incorrect indentation for `{{outlet}}` beginning at L31:C4. Expected `{{outlet}}` to be at an indentation of 6 but was found at 4.  block-indentation\n  18:6  error  Incorrect indentation for `<ul>` beginning at L18:C6. Expected `<ul>` to be at an indentation of 8 but was found at 6.  block-indentation\n  28:6  error  Incorrect indentation for `{{no-result}}` beginning at L28:C6. Expected `{{no-result}}` to be at an indentation of 8 but was found at 6.  block-indentation\n');
  });
  QUnit.test('entry-task/templates/me/going.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'entry-task/templates/me/going.hbs should pass TemplateLint.\n\nentry-task/templates/me/going.hbs\n  12:0  error  Incorrect indentation for `{{no-result}}` beginning at L12:C0. Expected `{{no-result}}` to be at an indentation of 2 but was found at 0.  block-indentation\n');
  });
  QUnit.test('entry-task/templates/me/likes.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'entry-task/templates/me/likes.hbs should pass TemplateLint.\n\nentry-task/templates/me/likes.hbs\n  12:0  error  Incorrect indentation for `{{no-result}}` beginning at L12:C0. Expected `{{no-result}}` to be at an indentation of 2 but was found at 0.  block-indentation\n');
  });
  QUnit.test('entry-task/templates/me/past.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'entry-task/templates/me/past.hbs should pass TemplateLint.\n\nentry-task/templates/me/past.hbs\n  12:0  error  Incorrect indentation for `{{no-result}}` beginning at L12:C0. Expected `{{no-result}}` to be at an indentation of 2 but was found at 0.  block-indentation\n');
  });
});
define("entry-task/tests/lint/tests.lint-test", [], function () {
  "use strict";
  ...
  QUnit.test('integration/components/channel-button-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/channel-button-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/channel-choice-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/channel-choice-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/comment-list-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/comment-list-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/comment-user-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/comment-user-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/e-button-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/e-button-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/e-header-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/e-header-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/e-home-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/e-home-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/e-me-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/e-me-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/e-search-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/e-search-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/event-list-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/event-list-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/nav-link-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/nav-link-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/no-result-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/no-result-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/reply-comment-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/reply-comment-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/slide-bar-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/slide-bar-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/user-nav-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/user-nav-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/view-all-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/view-all-test.js should pass ESLint\n\n');
  });
  QUnit.test('test-helper.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'test-helper.js should pass ESLint\n\n');
  });
  QUnit.test('unit/controllers/details/comments-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/details/comments-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/controllers/details/index-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/details/index-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/controllers/details/participants-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/details/participants-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/controllers/me/going-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/me/going-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/controllers/me/likes-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/me/likes-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/controllers/me/past-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/me/past-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/routes/details-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/details-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/routes/details/comments-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/details/comments-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/routes/details/index-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/details/index-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/routes/details/participants-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/details/participants-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/routes/event-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/event-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/routes/index-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/index-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/routes/me-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/me-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/routes/me/going-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/me/going-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/routes/me/likes-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/me/likes-test.js should pass ESLint\n\n');
  });
  QUnit.test('unit/routes/me/past-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/me/past-test.js should pass ESLint\n\n');
  });
});
...
define("entry-task/tests/test-helper", ["entry-task/app", "entry-task/config/environment", "@ember/test-helpers", "ember-qunit"], function (_app, _environment, _testHelpers, _emberQunit) {
  "use strict";

  (0, _testHelpers.setApplication)(_app.default.create(_environment.default.APP));
  (0, _emberQunit.start)();
});
define("entry-task/tests/unit/controllers/details/comments-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Controller | details/comments', function (hooks) {
...
define("entry-task/tests/unit/controllers/details/index-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Controller | details/index', function (hooks) {
    (0, _emberQunit.setupTest)(hooks); // Replace this with your real tests.
...
define("entry-task/tests/unit/controllers/details/participants-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Controller | details/participants', function (hooks) {
    (0, _emberQunit.setupTest)(hooks); // Replace this with your real tests.

    (0, _qunit.test)('it exists', function (assert) {
      let controller = this.owner.lookup('controller:details/participants');
      assert.ok(controller);
    });
  });
});
define("entry-task/tests/unit/controllers/me/going-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Controller | me/going', function (hooks) {
    (0, _emberQunit.setupTest)(hooks); // Replace this with your real tests.
...
define("entry-task/tests/unit/controllers/me/likes-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Controller | me/likes', function (hooks) {
    (0, _emberQunit.setupTest)(hooks); // Replace this with your real tests.

    (0, _qunit.test)('it exists', function (assert) {
      let controller = this.owner.lookup('controller:me/likes');
      assert.ok(controller);
    });
  });
});
define("entry-task/tests/unit/controllers/me/past-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Controller | me/past', function (hooks) {
    (0, _emberQunit.setupTest)(hooks); // Replace this with your real tests.
...
define("entry-task/tests/unit/routes/details-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | details', function (hooks) {
...
define("entry-task/tests/unit/routes/details/comments-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | details/comments', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
...
define("entry-task/tests/unit/routes/details/index-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | details/index', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
...
define("entry-task/tests/unit/routes/details/participants-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | details/participants', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
...
define("entry-task/tests/unit/routes/event-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | event', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
...
define("entry-task/tests/unit/routes/index-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";
...
define("entry-task/tests/unit/routes/me-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | me', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
...
define("entry-task/tests/unit/routes/me/going-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | me/going', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
...
define("entry-task/tests/unit/routes/me/likes-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | me/likes', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:me/likes');
      assert.ok(route);
    });
  });
});
define("entry-task/tests/unit/routes/me/past-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | me/past', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
...
require('entry-task/tests/test-helper');
